"""Написать скрипт, который используя многопоточность, скачивает набор файлов из сети.
Файлов не должно быть меньше 20.
Для реализации функционала требуется использовать concurrent.futures.ThreadPoolExecutor."""
import time
import requests
import os
...
file_handler = logging.FileHandler('Log_HW18.log')
...
img_path = "./HW_18_19_Images/Thread/"
